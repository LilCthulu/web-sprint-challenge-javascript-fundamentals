...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Because nestedFunction is a closure
...
function lowerCaseNames(array) {
    ...
    array.map(item => {
        ...
        let sciName = item.scientific_name.toLowerCase();
        lowCaseAnimalNames.push(name, sciName);
    });
...
function USApop(array) {
    let popNum = array.reduce(function(acc, data) {
